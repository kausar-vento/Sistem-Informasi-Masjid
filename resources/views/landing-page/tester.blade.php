...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div id="logo">
                <a href="index.html"><img src="{{asset('assets/landing-page/assets/img/logo.png')}}" alt=""></a>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-1.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-2.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-3.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>App 2</h4>
                            <p>App</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-4.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Card 2</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-5.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Web 2</h4>
                            <p>Web</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-6.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>App 3</h4>
                            <p>App</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-7.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Card 1</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-8.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Card 3</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="{{asset('assets/landing-page/assets/img/portfolio/portfolio-9.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="pic"><img src="{{asset('assets/landing-page/assets/img/team-1.jpg')}}" alt=""></div>
                            <h4>Walter White</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="pic"><img src="{{asset('assets/landing-page/assets/img/team-2.jpg')}}" alt=""></div>
                            <h4>Sarah Jhinson</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="fade-up" data-aos-delay="300">
                            <div class="pic"><img src="{{asset('assets/landing-page/assets/img/team-3.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="fade-up" data-aos-delay="400">
                            <div class="pic"><img src="{{asset('assets/landing-page/assets/img/team-4.jpg')}}" alt=""></div>
                            <h4>Amanda Jepson</h4>
