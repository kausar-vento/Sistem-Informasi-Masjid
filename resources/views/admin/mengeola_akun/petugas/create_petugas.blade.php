@push('titles')
    <title>Menu Create Petugas Masjid</title>
@endpush
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <center>
                        <h5 class="mb-0">Form Penambahan Petugas</h5>
                    </center>
                    <small class="text-muted float-end">Default label</small>
                </div>
                <div class="card-body">
                    <form action="{{route('saveManagePetugas')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Petugas</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('nama_petugas') is-invalid @enderror" id="basic-default-name" name="nama_petugas"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="alamat_petugas" type="hidden" name="alamat_petugas" class="@error('alamat_petugas') is-invalid @enderror"
                                    value="{{old('alamat_petugas')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text"  name="username"
                                    class="form-control phone-mask @error('username') is-invalid @enderror" placeholder="Masukan username untuk petugas" aria-label="658 799 8941"
                                     />
                                    @error('username')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text"  name="password"
                                    class="form-control phone-mask @error('password') is-invalid @enderror" placeholder="Masukan password untuk petugas" aria-label="658 799 8941"
                                     />
                                    @error('password')
                                        <div class="form-text text-danger">{{$message}}</div>
                                    @enderror
